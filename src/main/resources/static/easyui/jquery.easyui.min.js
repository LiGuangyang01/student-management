...
_351(_35e,_35f);
opts.onAdd.call(_35e,_35f.title,_35f.manageExam);
if(_35f.selected){
_361(_35e,_35f.manageExam);
}
};
...
if(item){
item.width=_644;
var rule=this.getRule(item.manageExam);
if(rule){
...
var _772=_76b(_770,_771.manageExam!=undefined?_771.manageExam:_771.id);
...
view.insertRow.call(view,_78d,_78e.manageExam,_78e.row);
_78f.push(_78e.row);
...
var row=opts.finder.getRow(_794,_795.manageExam);
var _797=false;
_795.row=_795.row||{};
...
opts.view.updateRow.call(opts.view,_794,_795.manageExam,_795.row);
}
};
function _799(_79a){
...
var tr=opts.finder.getTr(_7b2,(_7b3.manageExam!=undefined?_7b3.manageExam:_7b3.id),_7b3.type);
if(!tr.length){
return;
}
